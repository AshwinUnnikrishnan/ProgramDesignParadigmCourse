 ...
 *
 * <p>Different {@code Duration} implementations should work together, meaning
 * that:
 *
 * <ul> <li>Two durations must be equal if they have the same number of seconds.
 * <li>The hash code of a duration is the result of calling {@link
 * Long#hashCode(long)} on its length in seconds. </ul>
 */
